...
public class dnepr_dms_89sd extends CustomMethods {
    ...
    public void default_test() throws Exception {
        ...
        openURLservice(driver, CV.baseUrl + "/service/144/general");
        ...
        setFieldValue(driver,sBP,"sBankIdPassport","Ваш документ");
        ...
        setFieldValue(driver, sBP, "sChildBirth", "Дата народження померлого");
        setFieldValue(driver, sBP, "sChildPOB", "Місце народження померлого");
        setFieldValue(driver, sBP, "sChildCitizenship", "Громадянство померлого");
        setFieldValue(driver, sBP, "sChildDoc", "Документ померлого");
        setFieldValue(driver, sBP, "sRegistrationAddress", "Поточна адреса реєстрації померлого");
        setFieldAutocomplete(driver,"sID_Public_SubjectOrganJoin","Соборний (Жовтневий) район");
        setFieldValue(driver, sBP, "sDate_of_death", "Дата смерті");
        setFieldValue(driver, sBP, "sDeathDoc", "Номер актового запису, серія та номер свідоцтва про смерть");
        setFieldSelectSlotDate(driver, sBP, "."+sBP+"_--_"+"visitDay"); 
        setFieldSelectSlotTime(driver, sBP, "."+sBP+"_--_"+"visitDay");
        setFieldFile(driver, sBP, "nSvidDeath", "src/test/resources/files/test.jpg");
        ...
        SetRegionFieldInputTypeEnum(driver, sBP, "asResult", "Померлого знято з реєстрації");
