 ...
 */
public class dms_0173_IDChangeFIO_iGov extends CustomMethods {
    ...
    public void default_test() throws Exception {
        ...
        String sBP = "dms_0173_IDChangeFIO_iGov";
        String email = "autotestbeta@gmail.com";

        _step("1. Вход по прямому URL на услугу");
        openURLservice(driver, CV.baseUrl + "/service/173/general");

        _step("3. Выбор области/города");
        o.selectRegion("Дніпропетровська");
        o.selectCity("Кам’янське (Дніпродзержинськ)");
        ...
        setFieldSelectSlotDate(driver, sBP, "."+sBP+"_--_"+"visitDay1"); 
        setFieldSelectSlotTime(driver, sBP, "."+sBP+"_--_"+"visitDay1");        
        ...
        SetRegionFieldInputTypeString(driver, sBP, "sCustom", "Auto");
