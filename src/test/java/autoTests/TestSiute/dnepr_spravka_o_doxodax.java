...
public class dnepr_spravka_o_doxodax extends CustomMethods {
    ...
    public void default_test() throws Exception {
        ...
        openURLservice(driver, CV.baseUrl + "/service/655/general");
        ...
        setFieldCalendar(driver, sBP, "dStop", "2017/04/30");
        setFieldValue(driver, sBP, "sAim", "Довідку буде надано до Пенсійного фонду");
        ...
        SetRegionFieldInputTypeEnum(driver, sBP, "aDecision", "Надати довідку про доходи фізичних осіб");
        SetRegionFieldInputTypeEnum(driver, sBP, "aDecision", "Надати довідку про доходи фізичних осіб");
