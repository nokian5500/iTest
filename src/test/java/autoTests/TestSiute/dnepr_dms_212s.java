...
public class dnepr_dms_212s extends CustomMethods {
    ...
    public void default_test() throws Exception {
        ...
        openURLservice(driver, CV.baseUrl + "/service/185/general");
        ...
        setFieldValue(driver, sBP, "sRegistrationAddress", "Поточна адреса реєстрації дитини");
        ...
        SetRegionFieldInputTypeEnum(driver, sBP, "asResult", "Дитину знято з реєстрації");
